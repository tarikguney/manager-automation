    ...
    public static class PassedDueWorkItemsTransform
    {
        public static TransformBlock<List<JObject>, string> Block =>
            new TransformBlock<List<JObject>, string>(workItems =>
            {
                ...
                {
                    var storyPoint = offendingWorkItem["fields"]["Microsoft.VSTS.Scheduling.StoryPoints"].Value<int>();
                    var activatedOn =
                    ...
                    var pointsToDays = IterationHelper.PointsToDays(storyPoint);
                    ...
                    messageBuilder.Append(
                        ...
                        $"is assigned to *{userDisplayName}* and estimated *{storyPoint}* points.\n\n");
                }
